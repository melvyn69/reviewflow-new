...
export const api = {
    ...
    organization: {
        ...
        saveWebhook: async (config: any) => { await delay(500); },
    ...
    notifications: {
        list: async () => [],
        markAllRead: async () => {},
        sendTestEmail: async (email: string) => { await delay(1000); }
    },
    global: {
    ...
    ai: {
        ...
        runCustomTask: async (task: any) => { await delay(2000); return { result: "Success" }; },
    ...
    google: {
        ...
        syncReviewsForLocation: async (locationId: string) => { await delay(2000); return 5; }
    },
    company: {
        search: async (query: string) => []
    },
